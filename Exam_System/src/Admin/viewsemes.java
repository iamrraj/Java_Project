 ...
 * @author RahulRaj
 */
public class viewsemes extends javax.swing.JFrame {

    /**
     * Creates new form viewsemes
     */
    public viewsemes() {
        initComponents();
        getConnection();
...
*/
   public void getEmpTable() {
    ...
    private void searchEmp() {
        ...
        try {
            ...
            if (jComboBoxSearch.getSelectedItem().equals("Search By : Name")) {
                sql = "SELECT * FROM Semester WHERE  name like '" + jTextFieldSearch.getText() + "%'";
            }
            else {
                sql = "SELECT * FROM Semester WHERE id like '" + jTextFieldSearch.getText() + "%'";
            }
            rs = st.executeQuery(sql);
            while (rs.next()) {
                String  col1 = rs.getString("id");
    ...
    private void deleteEmp() {
        if (jTableEmp.getSelectedRow() == -1) {
            if (jTableEmp.getSelectedRow() == 0) {
                ...
                Jmessage.setText("You need to select an Semester");
            }
        } else {
            int del = JOptionPane.showConfirmDialog(null, "Do you really want to delete this Semester?", "DELETE", JOptionPane.YES_NO_OPTION);
            if (del == 0) {
                int selectedRowIndex = jTableEmp.getSelectedRow();
                theQuery("delete from Semester where id='" + jTableEmp.getModel().getValueAt(selectedRowIndex, 0) + "'");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("View Semester");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewsemes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
