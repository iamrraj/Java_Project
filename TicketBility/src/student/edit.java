...
public class edit extends javax.swing.JFrame {
    ...
    public void getConnection(){
     ...
     public void getEmpTable(){
        DefaultTableModel emp = new DefaultTableModel(new String[]{"ID","Name", "Phone", "Department","Semester","Email","Address"}, 0);
        try{
            ...
            while(rs.next())
            {
                ...
                String col4 = rs.getString("Departmenty");                
     ...
     private void searchEmp(){
        DefaultTableModel emp = new DefaultTableModel(new String[]{"ID","Name", "Phone", "Department","Semester","Email","Sex"}, 0);
        try{
            st = conn.createStatement();
            String sql= null;
            if(jComboBoxSearch.getSelectedItem().equals("Search By : Name")){
                sql = "SELECT * FROM student WHERE Last_Name like '"+jTextFieldSearch.getText()+"%' or First_Name like '"+jTextFieldSearch.getText()+"%'";
            }
            else if(jComboBoxSearch.getSelectedItem().equals("ID")){
                sql = "SELECT * FROM student WHERE ID like '"+jTextFieldSearch.getText()+"%'";
            }
            else if(jComboBoxSearch.getSelectedItem().equals("Department")){
                sql = "SELECT * FROM student WHERE Departmenty like '"+jTextFieldSearch.getText()+"%'";
            }
            else{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(126, 126, 126)
                .addComponent(jLabelMessage, javax.swing.GroupLayout.PREFERRED_SIZE, 737, javax.swing.GroupLayout.PREFERRED_SIZE)
