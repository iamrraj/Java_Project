...
public class teacher extends javax.swing.JFrame {
    ...
    private void addEmp(){
        //if(!jTextFieldID.getText().equals("")  && jTextFieldName2.getText().equals("") && jDateChooserDOB1.getDate() != null && jDateChooserDOB.getDate() != null){
            try{
            //theQuery("INSERT INTO teacher(ID,Last_Name,Departmenty,salary) VALUES ('"+jTextFieldID.getText()+"','"+jTextFieldName2.getText()+"','"+jComboBoxDept.getSelectedItem()+"','"+ salary.getText()+"')");
           // theQuery("INSERT INTO teacher_details(ID,DOB,Sex,Nationality,Join_Date,Address) VALUES ('"+jTextFieldID.getText()+"','"+((JTextField) jDateChooserDOB2.getDateEditor().getUiComponent()).getText()+"','"+jComboBoxSex.getSelectedItem()+"','"+jTextFieldNat.getText()+"','"+((JTextField) jDateChooserDOB.getDateEditor().getUiComponent()).getText()+"','"+jTextFieldAddress.getText()+"')");
           // theQuery("INSERT INTO teacher_phone(ID,Phone,email) VALUES ('"+jTextFieldID.getText()+"','"+jTextFieldPhone2.getText()+"','"+jTextFieldEmail.getText()+"')");
            theQuery("INSERT INTO teacher(ID,Last_Name,Departmenty,salary,DOB,Sex,Nationality,Join_Date,Address,Phone,email) VALUES ('"+jTextFieldID.getText()+"','"+jTextFieldName2.getText()+"','"+jComboBoxDept.getSelectedItem()+"','"+salary.getText()+ "','"+
                    ((JTextField) jDateChooserDOB.getDateEditor().getUiComponent()).getText()+"','"+jComboBoxSex.getSelectedItem()+"','"+jTextFieldNat.getText()+"','"+((JTextField) jDateChooserDOB1.getDateEditor().getUiComponent()).getText()+"','"+jTextFieldAddress.getText()+"','"+jTextFieldPhone2.getText()+"','"+jTextFieldEmail.getText()+"')");
    ...
    private void initComponents() {
        ...
        jDateChooserDOB1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jDateChooserDOB1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jDateChooserDOB1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
